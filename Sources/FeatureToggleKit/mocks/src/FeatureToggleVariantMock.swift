...
// MARK: - FeatureToggleVariantMock

public final class FeatureToggleVariantMock: FeatureToggleVariant, @unchecked Sendable {
  // MARK: Lifecycle

  public init() {}
  public init(definition: FeatureToggleDefinition, value: FeatureToggleValue) {
  ...
  private var _definition: FeatureToggleDefinition!

  private var _value: FeatureToggleValue! { didSet { valueSetCallCount += 1 } }
}
